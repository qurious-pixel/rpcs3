...
if(MSVC)
	if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
		...
		if (COMPILER_X86)
			add_compile_options(-fuse-ld=lld -msse -msse2 -mcx16 -mavx -mavx2 -mavx512f -mavx512vbmi -mavx512vl -mavx512dq -mavx512vpopcntdq -maes -mrtm -mpclmul -mmwaitx -mwaitpkg)
		endif()

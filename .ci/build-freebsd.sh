...
git submodule -q update --init --depth 1 $(awk '/path/ && !/llvm/ && !/ffmpeg/ && !/VulkanMemoryAllocator/ && !/opencv/ && !/libpng/ && !/libsdl-org/ && !/curl/ && !/zlib/ && !/libusb/ && !/feralinteractive/ { print $3 }' .gitmodules)
